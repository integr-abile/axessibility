...
\t subUnderscores.pl -o originalfile.tex outputfile.tex
...
subUnderscores.pl -o "$ARGV[0]" [needs another name here]
...
ERROR:
\t You're calling subUnderscores.pl with two file names, but not the -o flag.
